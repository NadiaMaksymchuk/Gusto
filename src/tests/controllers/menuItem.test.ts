...
container.bind<IMenuItemsService>('IMenuItemsService').toConstantValue(mockMenuItemsService)
...
describe('restoraunt controller', () => {
  ...
  test('getAllByRestaurantId should return ApiResponse with status 200', async () => {
    ...
    const response = new ApiResponse(HttpStatusCode.OK, mockMenuItems, 'Menu items retrieved successfully')

    ;(mockMenuItemsService.getAllByRestaurantId as jest.Mock).mockResolvedValueOnce(response)
    ...
    expect(mockMenuItemsService.getAllByRestaurantId).toHaveBeenCalledWith(restaurantId)
  })
  ...
  test('getMenuById should return ApiResponse with status 200 for existing menu item', async () => {
    ...
    const response = new ApiResponse(HttpStatusCode.OK, mockMenuItem, 'Menu item retrieved successfully')

    ;(mockMenuItemsService.getMenuById as jest.Mock).mockResolvedValueOnce(response)
  ...
  test('addMenuItem should return ApiResponse with status 201', async () => {
    ...
    const response = new ApiResponse(HttpStatusCode.Created, null, 'Menu item created successfully')

    ;(mockMenuItemsService.addMenuItem as jest.Mock).mockResolvedValueOnce(response)
  ...
  test('updateMenuItem should return ApiResponse with status 200 for existing menu item', async () => {
    ...
    const response = new ApiResponse(HttpStatusCode.OK, mockMenuItem, 'Menu item created successfully')

    ;(mockMenuItemsService.updateMenuItem as jest.Mock).mockResolvedValueOnce(response)
  ...
  test('deleteMenuItem should return ApiResponse with status 204 for existing menu item', async () => {
    ...
    const response = new ApiResponse(HttpStatusCode.NoContent, null, 'Menu item deleted successfully')
    ;(mockMenuItemsService.deleteMenuItem as jest.Mock).mockResolvedValueOnce(response)
