...
describe('user controller', () => {
  ...
  test('should create a new chat successfully', async () => {
    ...
    const response = new ApiResponse(HttpStatusCode.Created, null, 'Chat created successfully')
  ...
  test('should return a chat by id', async () => {
    ...
    const response = new ApiResponse(HttpStatusCode.OK, expectedChat, 'Chat retrieved successfully')
  ...
  test('should return chats for a user successfully', async () => {
    ...
    const response = new ApiResponse(HttpStatusCode.OK, expectedChats, 'Chat retrieved successfully')

    ;(mockChatService.getChatsByUserId as jest.Mock).mockResolvedValueOnce(response)
  ...
  test('should return the number of unread messages for a chat', async () => {
    ...
    ;(mockChatService.getNumberOfUnreadMessages as jest.Mock).mockResolvedValueOnce(response)
  ...
  test('should delete a chat successfully', async () => {
    ...
    const response = new ApiResponse(HttpStatusCode.NoContent, null, 'Chat deleted successfully')
  ...
  test('should create a new message successfully', async () => {
    ...
    const response = new ApiResponse(HttpStatusCode.Created, null, 'Message created successfully')

    ;(mockChatService.createMessage as jest.Mock).mockResolvedValueOnce(response)
  ...
  test('should update a message successfully', async () => {
    ...
    const response = new ApiResponse(HttpStatusCode.OK, null, 'Message updated successfully')

    ;(mockChatService.updateMessage as jest.Mock).mockResolvedValueOnce(response)
  ...
  test('should get the last message in a chat', async () => {
    ...
    const response = new ApiResponse(HttpStatusCode.OK, expectedLastMessage, 'Last message retrieved successfully')

    ;(mockChatService.getLastMessage as jest.Mock).mockResolvedValueOnce(response)
    ...
    await chatController.getUnreadAndLastMessagesAsync(mockRequest, mockResponse)
  ...
  test('should get the first 30 messages in a chat', async () => {
    ...
    const response = new ApiResponse(HttpStatusCode.OK, expectedMessages, 'First 30 messages retrieved successfully')

    ;(mockChatService.getFirst30MessagesByChatId as jest.Mock).mockResolvedValueOnce(response)
  ...
  test('should delete a message successfully', async () => {
    ...
    const response = new ApiResponse(HttpStatusCode.NoContent, null, 'Message deleted successfully')

    ;(mockChatService.deleteMessage as jest.Mock).mockResolvedValueOnce(response)
