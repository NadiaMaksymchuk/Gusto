...
container
  .bind<ICouriersService>("ICouriersService")
  .toConstantValue(mockCourierService);
...
describe("courier controller", () => {
  ...
  test("should signUp", async () => {
    ...
    (mockCourierService.signUp as jest.Mock).mockResolvedValueOnce(
      mockApiResponse,
    );
  ...
  test("should sign in successfully", async () => {
    ...
    (mockCourierService.signIn as jest.Mock).mockResolvedValueOnce(
      mockApiResponse,
    );
  ...
  test("should return all couriers", async () => {
    ...
    (mockCourierService.getAllCouriers as jest.Mock).mockResolvedValueOnce(
      response,
    );
  ...
  test("should return a courier by id", async () => {
    ...
    (mockCourierService.getCourierById as jest.Mock).mockResolvedValueOnce(
      response,
    );
  ...
  test("should update a courier successfully", async () => {
    ...
    (mockCourierService.updateCourier as jest.Mock).mockResolvedValueOnce(
      response,
    );
  ...
  test("should set availability status for a courier successfully", async () => {
    ...
    (
      mockCourierService.setAvailabilityStatus as jest.Mock
  ...
  test("should delete a courier successfully", async () => {
    ...
    (mockCourierService.deleteCourier as jest.Mock).mockResolvedValueOnce(
      response,
    );
