...
container
  .bind<IRestaurantService>("IRestaurantService")
  .toConstantValue(mockRestaurantService);
...
describe("restoraunt controller", () => {
  ...
  it("createRestaurant should return ApiResponse with status 201", async () => {
    ...
    (mockRestaurantService.createRestaurant as jest.Mock).mockResolvedValueOnce(
      mockApiResponse,
    );
  ...
  it("getRestaurantById should return ApiResponse with status 200 for existing restaurant", async () => {
    ...
    (
      mockRestaurantService.getRestaurantById as jest.Mock
  ...
  test("deleteRestaurant should return ApiResponse with status 204 for existing restaurant", async () => {
    ...
    (mockRestaurantService.deleteRestaurant as jest.Mock).mockResolvedValueOnce(
      mockApiResponse,
    );
