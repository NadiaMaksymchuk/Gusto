...
describe('DeliveryDetailsService', () => {
    ...
    test('deleteDeliveryDetail should return ApiResponse with status 204', async () => {
        ...
        expect(mockDeliveryDetailsRepository.deleteDeliveryDetail).toHaveBeenCalledWith(
            deliveryDetailId
        );
    });
    ...
    test('getDeliveryDetailsByCourierId should return ApiResponse with status 200', async () => {
        ...
        (mockDeliveryDetailsRepository.getDeliveryDetailsByCourierId as jest.Mock).mockResolvedValueOnce(mockDeliveryDetails);

        const response = await deliveryDetailsService.getDeliveryDetailsByCourierId(
            courierId
        );
        ...
        expect(mockDeliveryDetailsRepository.getDeliveryDetailsByCourierId).toHaveBeenCalledWith(
            courierId
        );
    });
});
