...
export class OrdersController {
  ...
  getOrdersWithOrderItemsAndImagesByUserAndStatus = async (req: Request, res: Response) => {
    ...
    const response = await this.orderService.getOrdersWithOrderItemsAndImagesByUserAndStatus(userId, orderStatus)
  ...
  updateOrderStatus = async (req: Request, res: Response) => {
    ...
    const response = await this.orderService.updateOrderStatus(orderId, newStatus)
  ...
  updateDeliveryTime = async (req: Request, res: Response) => {
    ...
    const response = await this.orderService.updateDeliveryTime(orderId, newDeliveryTime)
