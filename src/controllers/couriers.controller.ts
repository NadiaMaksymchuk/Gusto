...
export class CouriersController {
  ...
  getCouriersByAvailabilityStatus = async (req: Request, res: Response) => {
    ...
    const response = await this.couriersService.getCouriersByAvailabilityStatus(status)
  ...
  updateCourier = async (req: Request, res: Response) => {
    ...
    const response = await this.couriersService.updateCourier(courierId, updatedCourierData)
    return res.status(response.status).json(response)
  }
  ...
  setAvailabilityStatus = async (req: Request, res: Response) => {
    ...
    const response = await this.couriersService.setAvailabilityStatus(courierId, availabilityStatus)
