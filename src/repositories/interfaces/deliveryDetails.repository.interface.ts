...
export interface IDeliveryDetailsRepository {
    createDeliveryDetail(newDeliveryDetail: CreateDeliveryDetailDto): Promise<void>;
    deleteDeliveryDetail(deliveryDetailId: number): Promise<void>;
    getDeliveryDetailsByCourierId(courierId: number): Promise<DeliveryDetailWithCourierOrderRestaurantAndOrderItemsDto[]>;
    getDeliveryDetailsByOrderId(orderId: number): Promise<DeliveryDetailWithCourierAndOrderDto[]>;
  }