...
export interface ICouriersRepository {
    ...
    updateCourier(courierId: number, updatedCourierData: UpdateCourierDto): Promise<void>;
    setAvailabilityStatus(courierId: number, availabilityStatus: number): Promise<void>;
